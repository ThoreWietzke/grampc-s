...
void init_polynomial(py::module_ &m)
{
    py::class_<Polynomial, PolynomialPtr>(m, "Polynomial")
        ...
        .def("get_coefficient", &Polynomial::getCoefficient)
    ...
    py::class_<MultivariatePolynomial, MultivariatePolynomialPtr>(m, "MultivariatePolynomial")
        ...
        .def_property("polynomials", &MultivariatePolynomial::getPolynomials, &MultivariatePolynomial::setPolynomials)
        .def("get_polynomial", &MultivariatePolynomial::getPolynomial)
