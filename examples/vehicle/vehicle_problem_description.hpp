...
class VehicleProblemDescription : public grampc_s::ProblemDescription
{
public:
    VehicleProblemDescription(const std::vector<typeRNum>& pSys, const std::vector<typeRNum>& pCost);
