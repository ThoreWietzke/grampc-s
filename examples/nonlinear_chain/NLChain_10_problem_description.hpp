...
#ifndef NLCHAIN10_HPP
#define NLCHAIN10_HPP

#include "problem_description/problem_description.hpp"

using namespace grampc_s;

class Chain_10_ProblemDescription : public grampc_s::ProblemDescription
{
public:
    Chain_10_ProblemDescription(const std::vector<typeRNum>& pCost);
