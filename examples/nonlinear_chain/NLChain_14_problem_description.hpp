...
#ifndef NLCHAIN14_HPP
#define NLCHAIN14_HPP

#include "problem_description/problem_description.hpp"

using namespace grampc_s;

class Chain_14_ProblemDescription : public grampc_s::ProblemDescription
{
public:
    Chain_14_ProblemDescription(const std::vector<typeRNum>& pCost);
