...
#ifndef NLCHAIN12_HPP
#define NLCHAIN12_HPP

#include "problem_description/problem_description.hpp"

using namespace grampc_s;

class Chain_12_ProblemDescription : public grampc_s::ProblemDescription
{
public:
    Chain_12_ProblemDescription(const std::vector<typeRNum>& pCost);
