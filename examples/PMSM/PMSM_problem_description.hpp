...
#ifndef PMSM_PROBLEM_DESCRIPTION_HPP
#define PMSM_PROBLEM_DESCRIPTION_HPP

#include "problem_description/problem_description.hpp"

using namespace grampc_s;

class PMSMProblemDescription : public grampc_s::ProblemDescription
{
public:
    PMSMProblemDescription(const std::vector<typeRNum>& pSys, const std::vector<typeRNum>& pCost, const std::vector<typeRNum>& pCon);
...
#endif // PMSM_PROBLEM_DESCRIPTION_HPP
